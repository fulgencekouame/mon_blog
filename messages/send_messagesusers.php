...
//requete pour afficher les messages non lus de l'user
...
<div class="container">
    ...
    <form class="box" action="" method="post" enctype = "multipart/form-data"> 
        <table class="table table-striped">
            ...
            <?php while ($mesuser = mysqli_fetch_array($messagequery)) {
                $idexp = $mesuser['id_expediteur'];
            ...
            <tr>
                <tbody>
                    <td> <?php echo($nom); ?></td>
                    <td><?php echo($mesuser['date']); ?></td>
                    <td><?php echo($mesuser['titre']); ?></td>
                    <td><a href="read_messagesusers.php?id=<?php echo($mesuser['id']); ?>"><button class="btn btn-primary">Lire</button></a></td>
                </tbody>
            </tr>
            <?php } ?>
        </table>
